...
public class AutoResizableTextView extends TextView {
    ...
    private float _maxTextSize, spacingMult = 1.0f;
    private float _spacingAdd = 0.0f, _minTextSize;
    ...
    public AutoResizableTextView(final Context context) {
        this(context, null, 0);
    }

    public AutoResizableTextView(final Context context, final AttributeSet attrs) {
...
//    });
    ...
    private void superSetTextSize(int startSize) {
        int textSize = binarySearch(startSize, (int) _maxTextSize, sizeTester, availableSpaceRect);
