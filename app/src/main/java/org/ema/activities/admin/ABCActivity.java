...
public class ABCActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(org.ema.R.layout.activity_abc);
    ...
    private void fillCheckedWords(){
        ...
        Object user = users.getAdapter().getItem(users.getCheckedItemPosition());
        Log.d(TAG, "For user " + user.toString());
        Student student = realm.where(Student.class).equalTo("nickname",user.toString()).findFirst();final ListView words = (ListView) findViewById(org.ema.R.id.wordsListView);
